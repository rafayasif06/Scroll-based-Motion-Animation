...
export const ScrollAnimation = () => {
  ...
  return (
    <section className="bg-stone-950 text-white">
      ...
      >
        <div className="fixe top-0 left-0  w-full flex items-center justify-center">
          <motion.div
            style={{ scale }}
...
//     damping: 30,
//   });
//   const scale = useTransform(smoothProgress, [0.8, 1.5], [1, 15]);
...
//       <div
//         ref={containerRef}
//         className=" w-full h-[350vh] relative overflow-hidden"
//       >
//         <div className="fixed top-0 left-0 bg-amber-950 w-full flex items-center justify-center">
//           <motion.div
//             style={{ scale }}
//             className="flex items-center justify-center bg-transparent text-[400px] text-white"
//           >
...
//         <div className="absolute top-[100vh] pt-[800px] w-full bg-white/5">
//           <div className="flex flex-col items-center justify-center">
//             <span className="pt-2">Over 1500 Projects Completed</span>
//             <AnimatedText />
//           </div>
